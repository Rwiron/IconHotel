        ...
        <div class="card-body">
            ...
            <form class="row g-3 needs-validation" novalidate method="post" action="{{ url('register') }}">
                ...
                <div class="col-12">
                    ...
                    <input type="text" name="lastname" class="form-control" id="yourLast" value="{{ old('lastname') }}">
                ...
                <div class="col-12">
                    <p class="small mb-0">Already have an account? <a href="{{ url('loginPage') }}">Log in</a></p>
                </div>
            </form>
        </div>
    </div>
